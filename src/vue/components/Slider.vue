<template>
    <div :class="classes">
        <InputNumber
                ...
                :value="currentValue"
                :disabled="disabled"
                @on-change="handleInputChange"></InputNumber>
        <div :class="[prefixClass + '-wrap']" ref="slider" @click.self="sliderClick">
            <input type="hidden" :name="name" :value="currentValue">
            <template v-if="showStops">
                <div :class="[prefixClass + '-stop']" v-for="item in stops" :style="{ 'left': item + '%' }" @click.self="sliderClick"></div>
            </template>
            <div :class="[prefixClass + '-bar']" :style="barStyle" @click.self="sliderClick"></div>
            <template v-if="range">
                <div
                        :class="[prefixClass + '-button-wrap']"
        ...
        computed: {
            classes () {
                return [
                    `${prefixClass}`,
                    {
                        [`${prefixClass}-input`]: this.showInput && !this.range,
                        [`${prefixClass}-range`]: this.range,
            ...
            buttonClasses () {
                return [
                    `${prefixClass}-button`,
                    {
                        [`${prefixClass}-button-dragging`]: this.dragging
                    }
                ];
            },
            button1Classes () {
                return [
                    `${prefixClass}-button`,
                    {
                        [`${prefixClass}-button-dragging`]: this.firstDragging
                    }
                ];
            },
            button2Classes () {
                return [
                    `${prefixClass}-button`,
                    {
                        [`${prefixClass}-button-dragging`]: this.secondDragging
                    }
                ];
            },
            barStyle () {
