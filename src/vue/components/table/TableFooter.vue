            ...
            return (
                <table
                    ...
                    <colgroup>
                        ...
                        {
                            !this.fixed && this.layout.gutterWidth ? <col name="gutter" width={ this.layout.scrollY ? this.layout.gutterWidth : '' }></col> : ''
                        }
                    </colgroup>
                    ...
                    <tr>
                        ...
                        {
                            this.hasGutter ? <td class="gutter" style={{ width: this.layout.scrollY ? this.layout.gutterWidth + 'px' : '0' }}></td> : ''
                        }
                    </tr>
                    </tbody>
                </table>
