<template>
    <div :class="classes">
        ...
        <div :class="[prefixClass+ '-list']" v-show="showSeconds" ref="seconds">
            <ul :class="[prefixClass + '-ul']">
...
<script>
    ...
    const prefixClass = 'time-picker-cells';
        ...
        computed: {
            classes () {
                return [
                    `${prefixClass}`,
                    {
                        [`${prefixClass}-with-seconds`]: this.showSeconds
                    }
                ];
            },
            hoursList () {
        ...
        methods: {
            getCellCls (cell) {
                return [
                    `${prefixClass}-cell`,
                    {
                        [`${prefixClass}-cell-selected`]: cell.selected,
