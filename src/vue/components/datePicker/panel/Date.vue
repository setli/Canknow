<template>
    <div :class="classes" @mousedown.prevent>
        ...
        <div :class="[prefixClass + '-body']">
            <div :class="[datePrefixClass + '-header']" v-show="currentView !== 'time'">
                <span
                    :class="iconButtonClass('prev', '-double')"
                    @click="changeYear(-1)"><Icon type="prev"></Icon></span>
                <span
                    :class="iconButtonClass('prev')"
                    @click="changeMonth(-1)"
                    v-show="currentView === 'Date'"><Icon type="prev"></Icon></span>
                <date-panel-label
                    :date-panel-label="datePanelLabel"
                    :current-view="currentView"
                    :date-prefix-class="datePrefixClass"/>
                <span
                    :class="iconButtonClass('next', '-double')"
                    @click="changeYear(+1)"><Icon type="next"></Icon></span>
                <span
                    :class="iconButtonClass('next')"
                    @click="changeMonth(+1)"
                    v-show="currentView === 'Date'"><Icon type="next"></Icon></span>
            </div>
