    ...
    const forced = {
        selection: {
            renderHeader: function(h) {
                return <checkbox nativeOn-click={ this.toggleAllSelection } value={ this.isAllSelected } />;
            },
            renderCell: function(h, { row, column, store, $index }) {
                return <checkbox value={ store.isSelected(row) } disabled={ column.selectable ? !column.selectable.call(null, row, $index) : false }
        ...
        expand: {
            ...
            renderCell: function(h, { row, store }, proxy) {
                ...
                return <div class={ 'table-expand-icon ' + (expanded ? 'table-expand-icon-expanded' : '') }
