<template>
    <div :class="classes" v-clickoutside="handleClose">
        <div ref="reference" :class="[prefixClass + '-rel']">
            <slot>
                <i-input
                        block
                        :element-id="elementId"
                        :class="[prefixClass + '-editor']"
        ...
        <transition :name="transition">
            <Drop
                    ...
                    v-show="opened"
                    :class="{ [prefixClass + '-transfer']: transfer }"
                    :placement="placement"
                    ref="drop"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            transition () {
                if (this.placement === 'bottom-left' || this.placement === 'bottom' || this.placement === 'bottom-right') {
                    return 'slide-up';
                }
                else {
                    return 'slide-down';
